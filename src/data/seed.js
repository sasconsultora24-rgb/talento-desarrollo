...
export const planesEmpresas = [
  {
    id: "basico",
    nombre: "Por Vacante",
    precio: "$80.000 por vacante",
    incluye: [
      "Publicación de 1 búsqueda por 45 días, sin suscripción mensual",
      "Acceso a los perfiles filtrados mientras la búsqueda está activa",
      "Pagás solo cuando necesitás contratar, no todos los meses",
      "Capacitaciones y mentorías para tu equipo: se cobran aparte",
    ],
  },
  {
    id: "avanzado",
    ...
    incluye: [
      ...
      "Hasta 3 integrantes de equipo con acceso propio a capacitaciones",
      "1 capacitación paga incluida por mes para cada integrante",
      "Badge de \"Empleador verificado\" en tus vacantes publicadas",
      "Plantilla de anuncio de vacante optimizada + banco de preguntas de entrevista",
      "Aviso automático si tenés postulantes sin revisar hace más de 3 días",
      "Soporte prioritario",
    ],
  },
  {
    ...
    incluye: [
      ...
      "2 capacitaciones pagas incluidas por mes para cada integrante",
      "1 Espacio de Orden (mentoría) por mes, para quien vos asignes",
      "Todo lo de Avanzado (badge, plantillas, avisos, soporte prioritario)",
    ],
  },
  {
    id: "platino",
